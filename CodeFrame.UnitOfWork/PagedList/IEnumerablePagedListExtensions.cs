...
namespace CodeFrame.UnitOfWork.PagedList
{
    /// <summary>
    ...
    public static class IEnumerablePagedListExtensions
    {
        ...
        //    (this IEnumerable<T> source, int pageIndex, int pageSize, int indexFrom = 0) =>
        ...
        //    (this IEnumerable<TSource> source, Func<IEnumerable<TSource>, 
        //        IEnumerable<TResult>> converter, int pageIndex, int pageSize, int indexFrom = 0)
